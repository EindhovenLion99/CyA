...
// Fecha: 08/10/2019
// Archivo cadena.h: Archivo de cabecera de la clase Cadena la cual nos permite
// concatenar
//                   cadenas e incluso obtener su inversa.
//
...
class Cadena {
 ...
 public:
  Cadena(string chain) : chain_(chain){};
  ~Cadena(){};

  string getChain(void);
  void setChain(string);
  string concatenacion(string, string);
